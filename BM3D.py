...
def bm3d(img_name):
    ...
    cv2.imwrite("/Users/chenjia/Desktop/1/{}_1st.jpg".format(pre), Basic_img)
    Final_img = BM3D_2nd_step(Basic_img, img)
    cv2.imwrite("/Users/chenjia/Desktop/1/{}_2nd.jpg".format(pre), Final_img)
...
#     auged = Erode_Dilate(path)
#     try:
#         circles = cv2.HoughCircles(auged[:,:,0],cv2.HOUGH_GRADIENT,1,100,param1=60,param2=50,minRadius=320,maxRadius=400)[0]
#     except:
#         continue
...
#     cv2.imshow(os.path.basename(path), auged)
#     cv2.waitKey(1000)
